 ...
 * @package     Opus_Model
 */
class Opus_Model_Dependent_Link_DocumentPersonLong extends Opus_Model_Dependent_Link_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_modelClass = 'Opus_PersonLong';
    ...
    protected function _init() {
        if (is_null($this->getId()) === false) {
            $this->setModel(new Opus_PersonLong($this->_primaryTableRow->person_id));
        }
