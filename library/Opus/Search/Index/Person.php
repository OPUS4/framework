 ...
 * @version     $Id: Document.php 2222 2009-03-20 13:04:15Z marahrens $
 */

class Opus_Search_Index_Person extends Zend_Search_Lucene_Document
{
    ...
    {
        $this->addField(Zend_Search_Lucene_Field::Text('role', $documentdata['role'], $this->__encoding));
        #$this->addField(Zend_Search_Lucene_Field::Text('name', $documentdata['name'], $this->__encoding));
        $this->addField(Zend_Search_Lucene_Field::Text('dbid', $documentdata['id'], $this->__encoding));
    }
}
