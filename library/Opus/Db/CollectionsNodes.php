...
/**
 * Table gateway class to table 'collections_structure'.
 *
 * @category    Framework
 * @package     Opus_Db
 * @see         Opus_Db_NestedSet
 *
 */

class Opus_Db_CollectionsNodes extends Opus_Db_NestedSet {
     ...
     * @var string
     */
    protected $_name   = 'collections_nodes';
    ...
    protected $_referenceMap = array(
            ...
            'Parent' => array(
                            'columns' => 'parent_id',
                            'refTableClass' => 'Opus_Db_CollectionsNodes',
                            'refColumns' => 'id',
            ),
    );
