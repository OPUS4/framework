...
-- -----------------------------------------------------
-- Table `opus400`.`document_publications`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `opus400`.`document_publications` (
  `document_publication_id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `documents_id` INT UNSIGNED NOT NULL ,
  `institutes_id` INT UNSIGNED NULL ,
  `status` ENUM('published', 'unpublished', 'deleted') NOT NULL ,
  `published_date` DATE NULL ,
  `published_year` YEAR NULL ,
  `publisher_name` VARCHAR(255) NULL ,
  `publisher_place` VARCHAR(255) NULL ,
  PRIMARY KEY (`document_publication_id`) ,
  INDEX `fk_document_publications_documents` (`documents_id` ASC) ,
  INDEX `fk_document_publications_institutes_contents` (`institutes_id` ASC) ,
  CONSTRAINT `fk_document_publications_documents`
    FOREIGN KEY (`documents_id` )
    REFERENCES `opus400`.`documents` (`documents_id` )
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_document_publications_institutes_contents`
...
-- -----------------------------------------------------
-- Table `opus400`.`link_persons_publications`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `opus400`.`link_persons_publications` (
  `persons_id` INT UNSIGNED NOT NULL ,
  `document_publication_id` INT UNSIGNED NOT NULL ,
  `institutes_id` INT UNSIGNED NULL ,
  ...
  PRIMARY KEY (`persons_id`, `document_publication_id`) ,
  INDEX `fk_link_persons_publications_document_publications` (`document_publication_id` ASC) ,
  ...
  CONSTRAINT `fk_link_documents_persons_persons`
    ...
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_link_persons_publications_document_publications`
    FOREIGN KEY (`document_publication_id` )
    REFERENCES `opus400`.`document_publications` (`document_publication_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE  TABLE IF NOT EXISTS `opus400`.`link_documents_licences` (
  `documents_id` INT UNSIGNED NOT NULL ,
  `licences_id` INT UNSIGNED NOT NULL ,
