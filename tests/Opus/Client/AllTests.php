...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Client_AllTests::main');
}
...
class Opus_Client_AllTests {
    ...
    public static function suite() {
        $suite = new PHPUnit_Framework_TestSuite('Opus Application Framework - Opus_Client');
        return $suite;
    }
...
if (PHPUnit_MAIN_METHOD === 'Opus_Client_AllTests::main') {
    Opus_Client_AllTests::main();
}
