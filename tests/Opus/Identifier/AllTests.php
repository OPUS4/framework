...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Identifier_AllTests::main');
}
 ...
 */
class Opus_Identifier_AllTests {
...
if (PHPUnit_MAIN_METHOD === 'Opus_Identifier_AllTests::main') {
    Opus_Identifier_AllTests::main();
}
