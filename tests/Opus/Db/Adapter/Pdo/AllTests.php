 ...
 * Opus_Db_Adapater_Pdo subpackage.
 *
...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Db_Adapter_Pdo_AllTests::main');
}
...
class Opus_Db_Adapter_Pdo_AllTests {
    ...
    public static function suite() {
        $suite = new PHPUnit_Framework_TestSuite('Opus Application Framework - Opus_Db_Adapter_Pdo');
        $suite->addTestSuite('Opus_Db_Adapter_Pdo_Mysqlutf8Test');
        return $suite;
    }
...
if (PHPUnit_MAIN_METHOD === 'Opus_Db_Adapter_Pdo_AllTests::main') {
    Opus_Db_Adapter_Pdo_AllTests::main();
}
