...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Db_Adapter_AllTests::main');
}
...
if (PHPUnit_MAIN_METHOD === 'Opus_Db_Adapter_AllTests::main') {
    Opus_Db_Adapter_AllTests::main();
}
