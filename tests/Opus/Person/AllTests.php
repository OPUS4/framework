...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Person_AllTests::main');
}
...
if (PHPUnit_MAIN_METHOD === 'Opus_Person_AllTests::main') {
    Opus_Person_AllTests::main();
}
