...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Collection_AllTests::main');
}
 ...
 * @package     Opus_Collection
 */
class Opus_Collection_AllTests {
    ...
    public static function suite() {
        ...
        // TODO: $suite->addTestSuite('Opus_Collection_BasicCollectionTests');
        return $suite;
    }
...
if (PHPUnit_MAIN_METHOD === 'Opus_Collection_AllTests::main') {
    Opus_Collection_AllTests::main();
}
