 ...
 * @group DateTest
 */
class Opus_DateTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCreateWithStringConstructionArgument() {
        ...
        $this->assertEquals($od->getYear(), 1972, 'Year values dont match.');        
        $this->assertEquals($od->getMonth(), 11, 'Month values dont match.');        
        $this->assertEquals($od->getDay(), 10, 'Day values dont match.');        
    }
