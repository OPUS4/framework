...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Application_AllTests::main');
}
 ...
 * @subpackage  Data
 */
class Opus_Application_AllTests {
    ...
    public static function suite() {
        $suite = new PHPUnit_Framework_TestSuite('Opus Application Framework - Opus_Application');
        return $suite;
    }
...
if (PHPUnit_MAIN_METHOD === 'Opus_Application_AllTests::main') {
    Opus_Application_AllTests::main();
}
