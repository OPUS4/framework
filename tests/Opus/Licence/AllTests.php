...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Licence_AllTests::main');
}
...
class Opus_Licence_AllTests {
    ...
    public static function suite() {
        $suite = new PHPUnit_Framework_TestSuite('Opus Application Framework - Opus_Licence');
        return $suite;
    }
...
if (PHPUnit_MAIN_METHOD === 'Opus_Licence_AllTests::main') {
    Opus_Licence_AllTests::main();
}
