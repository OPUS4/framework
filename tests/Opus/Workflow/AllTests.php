...
if ( defined('PHPUnit_MAIN_METHOD') === false ) {
    define('PHPUnit_MAIN_METHOD', 'Opus_Workflow_AllTests::main');
}
...
class Opus_Workflow_AllTests {
    ...
    public static function suite() {
        $suite = new PHPUnit_Framework_TestSuite('Opus Application Framework - Opus_Workflow');
        return $suite;
    }
...
if (PHPUnit_MAIN_METHOD === 'Opus_Workflow_AllTests::main') {
    Opus_Workflow_AllTests::main();
}
